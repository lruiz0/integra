<?php
/**
* Juego que sirve para contestar preguntas sobre habilidades
* lingüísticas. (Debería hacerlas un Lingüista).
*/
?>
    ...
    <head>
        ...
        <script>
            ...
            function cargarPreguntas() {
                ...
                $.getJSON("{{ asset('json/preguntas-lenguaje.json') }}",
                    function(result) {
    ...
    <body onload="cargarPreguntas()">
        <div class="optimalsort-task">
            <div class="task-header">
                <a href="{{ route('menuLenguaje') }}" class="os-logo">
