<?php
/**
* Sub-menú de juegos para fomentar las habilidades de gestión de dinero. 
*/
?>
...
<html lang="en">
    <head>
        ...
        <title>Integra</title>
        <meta name="description" content="Main automanagement games menu" />
        <meta name="keywords" content="integra, automanagement menu"/>
    ...
    <body>
        <div class="container-fluid">
            <header>
                <h1>Juegos de <span style="color:grey;" 
                    class="animated flipIn">Autogestión</span>
                </h1>
            </header>
        </div>
        <hr/>
                ...
                <div class="mediaGame col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <div class="row">
                        ...
                        <div class=" col-md-5 col-lg-4">
                            ...
                            <p>¡Aprende a manejar monedas y billetes de forma 
                                fácil y sencilla! </p>
                        </div>
                    </div>
                </div>
