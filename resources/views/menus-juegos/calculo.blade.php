...
<body>
    ...
    <div id="content">
        ...
        <a href="{{ route('jCalculo') }}"><button type="button" class="btn btn-primary btn-lg center-block">Juego 1</button></a>
        <a href="#"><button type="button" class="btn btn-primary btn-lg center-block">Juego 2</button>
