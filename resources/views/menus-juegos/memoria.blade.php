...
<body>
    ...
    <div id="content">
        ...
        <a href="{{ route('jMemoriaCandyCrack') }}"><button type="button" class="btn btn-primary btn-lg center-block">Juego 1</button></a>
        <a href="{{ route('jMemoriaMemory') }}"><button type="button" class="btn btn-primary btn-lg center-block">Juego 2</button>
