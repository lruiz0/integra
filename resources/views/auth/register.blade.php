        ...
        <div class="formBack">
            ...
            url('/auth/register') }}">
                ...
                <div class="form_header">
                    ...
                    <h2 class="form-group-heading">¡Registrate!</h2>
                </div>
                <div class="form-group">
                    <label for="inputName">Nombre</label>
                    <input name="name" type="text" id="inputName"
                    class="form-control input-lg" placeholder="Nombre"
                    value="{{ old('name') }}" required autofocus/><!--<br/>-->
                </div>
                <div class="form-group">
                    <label for="inputApellidos">Apellidos</label>
                    <input name="apellidos" type="text" id="inputApellidos"
                    class="form-control input-lg" placeholder="Apellidos"
                    value="{{ old('apellidos') }}" required/><!--<br/>-->
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <label class="radio-inline">
                        <input name="tipo" type="radio" id="Usuari"
                        value="Usuario" required/> Usuario
                    </label>
                    <label class="radio-inline">
                        <input name="tipo" type="radio" id="Cuidador"
                        value="Cuidador" required/> Cuidador
                    </label><br/>
                </div>
                <div class="form-group">
                    <label for="exampleInputFile">Quieres subir una foto?
                    </label>
                    <input name="foto" type="file" id="exampleInputFile"/>
                    <p class="help-block">Para subir una foto de perfil haz
                        click en browse.</p>
                </div>
